...
do_action(_, UO, _, ObjectID, c, UO, PotentialActors, PotentialActors, 1) :- my_agent(Agent),!, query_world(agent_topup_energy,[Agent, c(ObjectID)]).
